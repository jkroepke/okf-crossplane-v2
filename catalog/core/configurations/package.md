...
It can contain [CompositeResourceDefinitions](../composite-resource-definition.md) and [Compositions](../composition.md), and can declare Provider, Function, or Configuration dependencies.[1][3] The
package manager installs these parts so the same control-plane capabilities can be distributed across clusters.[2]
...
The documentation initially summarizes installed content as Compositions, XRDs, and Providers, while its dependency section also permits Functions and nested Configurations; this catalog retains the broader, explicit dependency list.[3]
