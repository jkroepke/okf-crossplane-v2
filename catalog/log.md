...
* **Creation**: Added a commit-pinned summary of the Composition Functions specification, verified identical in v2.3.3 and explicitly separated from operation functions.
