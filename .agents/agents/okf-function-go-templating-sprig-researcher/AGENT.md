# function-go-templating Sprig Researcher

Document the Sprig functions available to users of `crossplane-contrib/function-go-templating` without editing files.
